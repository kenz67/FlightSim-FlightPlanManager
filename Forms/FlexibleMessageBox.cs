...
namespace FlightPlanManager.Forms
{
     ...
     * History:
     * 21.December.2022
     *  - Removed warnings, refactored some code
    ...
    */
    ...
    public static class FlexibleMessageBox
    {
        ...
        /// <summary>
        /// <para>Defines the maximum width for all FlexibleMessageBox instances in percent of the working area.</para>
        /// <para>
        ...
        /// </para>
        /// <para>Default is: 70% of the working area width.</para>
        /// </summary>
        public static double MAX_WIDTH_FACTOR = 1.0;

        /// <summary>
        /// <para>Defines the maximum height for all FlexibleMessageBox instances in percent of the working area.</para>
        /// <para>
        /// Allowed values are 0.2 - 1.0 where:
        ...
        /// </para>
        /// <para>Default is: 90% of the working area height.</para>
        /// </summary>
        public static double MAX_HEIGHT_FACTOR = 1.0;

        /// <summary>
        /// <para>Defines the font for all FlexibleMessageBox instances.</para>
        /// <para>Default is: SystemFonts.MessageBoxFont</para>
        /// </summary>
        ...
        #endregion Public show functions
        ...
        private class FlexibleMessageBoxForm : Form
        {
            ...
            private void InitializeComponent()
            {
                ...
                this.richTextBoxMessage.LinkClicked += this.RichTextBoxMessage_LinkClicked;
                //
                // panel1
                //
            ...
            { OK = 0, CANCEL, YES, NO, ABORT, RETRY, IGNORE };
            ...
            /// <summary>
            /// <para>Ensure the given working area factor in the range of  0.2 - 1.0 where:</para>
            /// <para>
            ...
            #endregion Properties (only used for binding)
            ...
            #endregion Public show function
        } //class FlexibleMessageBoxForm

        #endregion Internal form class
    }
}