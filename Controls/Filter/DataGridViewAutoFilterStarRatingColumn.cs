...
using FlightPlanManager.Controls;
...
namespace DataGridViewAutoFilter
{
    ...
    public class DataGridViewAutoFilterStarRatingColumn : DataGridViewColumn
    {
        ...
        #endregion public properties that hide inherited, non-virtual properties: DefaultHeaderCellType and SortMode
        ...
        #endregion public, static, convenience methods: RemoveFilter and GetFilterStatus
    }
}