...
namespace DataGridViewAutoFilter
{
    ...
    public class DataGridViewAutoFilterColumnHeaderCell : DataGridViewColumnHeaderCell
    {
        ...
        #endregion DataGridView events: HandleDataGridViewEvents, DataGridView event handlers, ResetDropDown, ResetFilter
        ...
        #endregion drop-down list: Show/HideDropDownListBox, SetDropDownListBoxBounds, DropDownListBoxMaxHeightInternal
        ...
        #endregion ListBox events: HandleDropDownListBoxEvents, UnhandleDropDownListBoxEvents, ListBox event handlers
        ...
        private void PopulateFilters()
        {
            ...
            varCustomize = "Customize";
            varAll = "All";
            varBlanks = "Blanks";
            varNonBlanks = "NonBlanks";
        ...
        #endregion filtering: PopulateFilters, FilterWithoutCurrentColumn, UpdateFilter, RemoveFilter, AvoidNewRowWhenFiltering, GetFilterStatus
        ...
        #endregion button bounds: DropDownButtonBounds, InvalidateDropDownButtonBounds, SetDropDownButtonBounds, AdjustPadding
        ...
        #endregion public properties: FilteringEnabled, AutomaticSortingEnabled, DropDownListBoxMaxLines
